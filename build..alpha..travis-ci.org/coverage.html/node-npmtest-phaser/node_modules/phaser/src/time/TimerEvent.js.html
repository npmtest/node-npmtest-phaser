...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-phaser/node_modules/phaser/src/time/TimerEvent.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-phaser/node_modules/phaser/src/time/TimerEvent.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-phaser/node_modules/phaser/src/time/</a> &#187; TimerEvent.js</div>
</div>
<div class="body">
...
*/
Phaser.TimerEvent = <span class="fstat-no" title="function not covered" >function (timer, delay, tick, repeatCount, loop, callback, callbackContext, args) {</span>
&nbsp;
    /**
...
&nbsp;
    ...
    */
<span class="cstat-no" title="statement not covered" >    this.tick = tick;</span>
&nbsp;
    /**
    * @property {number} repeatCount - If this TimerEvent repeats it will do so this many times.
    */
<span class="cstat-no" title="statement not covered" >    this.repeatCount = repeatCount - 1;</span>
&nbsp;
    /**
    * @property {boolean} loop - True if this TimerEvent loops, otherwise false.
    */
<span class="cstat-no" title="statement not covered" >    this.loop = loop;</span>
&nbsp;
    /**
...
&nbsp;
    ...
    */
<span class="cstat-no" title="statement not covered" >    this.callbackContext = callbackContext;</span>
&nbsp;
    /**
...
&nbsp;
    ...
    * @protected
    */
<span class="cstat-no" title="statement not covered" >    this.pendingDelete = false;</span>
&nbsp;
};
&nbsp;
<span class="cstat-no" title="statement not covered" >Phaser.TimerEvent.prototype.constructor = Phaser.TimerEvent;</span>
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
</div>

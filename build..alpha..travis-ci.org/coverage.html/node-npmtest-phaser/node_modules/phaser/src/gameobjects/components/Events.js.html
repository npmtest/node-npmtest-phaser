...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-phaser/node_modules/phaser/src/gameobjects/components/Events.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-phaser/node_modules/phaser/src/gameobjects/components/Events.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-phaser/node_modules/phaser/src/gameobjects/components/</a> &#187; Events.js</div>
</div>
<div class="body">
...
*/
Phaser.Events = <span class="fstat-no" title="function not covered" >function (sprite) {</span>
&nbsp;
    /**
    * @property {Phaser.Sprite} parent - The Sprite that owns these events.
    */
<span class="cstat-no" title="statement not covered" >    this.parent = sprite;</span>
&nbsp;
    // The signals are automatically added by the corresponding proxy properties
&nbsp;
};
&nbsp;
<span class="cstat-no" title="statement not covered" >Phaser.Events.prototype = {</span>
&nbsp;
    /**
     * Removes all events.
     *
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this._onDestroy)           { <span class="cstat-no" title="statement not covered" >this._onDestroy.dispose(); </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (this._onAddedToGroup)      { <span class="cstat-no" title="statement not covered" >this._onAddedToGroup.dispose(); </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (this._onRemovedFromGroup)  { <span class="cstat-no" title="statement not covered" >this._onRemovedFromGroup.dispose(); </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (this._onRemovedFromWorld)  { <span class="cstat-no" title="statement not covered" >this._onRemovedFromWorld.dispose(); </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (this._onKilled)            { <span class="cstat-no" title="statement not covered" >this._onKilled.dispose(); </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (this._onRevived)           { <span class="cstat-no" title="statement not covered" >this._onRevived.dispose(); </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (this._onEnterBounds)       { <span class="cstat-no" title="statement not covered" >this._onEnterBounds.dispose(); </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (this._onOutOfBounds)       { <span class="cstat-no" title="statement not covered" >this._onOutOfBounds.dispose(); </span>}</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this._onInputOver)         { <span class="cstat-no" title="statement not covered" >this._onInputOver.dispose(); </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (this._onInputOut)          { <span class="cstat-no" title="statement not covered" >this._onInputOut.dispose(); </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (this._onInputDown)         { <span class="cstat-no" title="statement not covered" >this._onInputDown.dispose(); </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (this._onInputUp)           { <span class="cstat-no" title="statement not covered" >this._onInputUp.dispose(); </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (this._onDragStart)         { <span class="cstat-no" title="statement not covered" >this._onDragStart.dispose(); </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (this._onDragUpdate)        { <span class="cstat-no" title="statement not covered" >this._onDragUpdate.dispose(); </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (this._onDragStop)          { <span class="cstat-no" title="statement not covered" >this._onDragStop.dispose(); </span>}</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this._onAnimationStart)    { <span class="cstat-no" title="statement not covered" >this._onAnimationStart.dispose(); </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (this._onAnimationComplete) { <span class="cstat-no" title="statement not covered" >this._onAnimationComplete.dispose(); </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (this._onAnimationLoop)     { <span class="cstat-no" title="statement not covered" >this._onAnimationLoop.dispose(); </span>}</span>
&nbsp;
    },
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >Phaser.Events.prototype.constructor = Phaser.Events;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >for (var prop in Phaser.Events.prototype)</span>
{
<span class="cstat-no" title="statement not covered" >    if (!Phaser.Events.prototype.hasOwnProperty(prop) ||</span>
        prop.indexOf('on') !== 0 ||
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    (<span class="fstat-no" title="function not covered" >function (prop, backing) {</span></span>
        'use strict';
&nbsp;
        // The accessor creates a new Signal; and so it should only be used from user-code.
<span class="cstat-no" title="statement not covered" >        Object.defineProperty(Phaser.Events.prototype, prop, {</span>
            get: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >                return this[backing] || (this[backing] = new Phaser.Signal());</span>
            }
        });
&nbsp;
        // The dispatcher will only broadcast on an already-created signal; call this internally.
<span class="cstat-no" title="statement not covered" >        Phaser.Events.prototype[prop + '$dispatch'] = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            return this[backing] ? this[backing].dispatch.apply(this[backing], arguments) : null;</span>
        };
&nbsp;
    })(prop, '_' + prop);
&nbsp;
